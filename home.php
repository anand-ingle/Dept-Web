    ...
    <div class="container p-1">
      <div class="row">
        <div class="p-2 col-md-4">
          <h2 class="mb-4 text">Other Links
            <br> </h2>
          <ul class="list-unstyled">
            <a href="#" class="text-white">GECA Home</a>
            <br>
            <a href="#" class="text-white">About Us</a>
            <br>
            <a href="#" class="text-white">NPTEL</a>
            <br>
            <a href="#" class="text-white">GATE</a>
          </ul>
        </div>
        <div class="p-2 col-md-4">
          <h2 class="mb-4">Contact</h2>
          <div class="col-md-12 p-1 col-2 col-sm-1">
            <a href="https://www.facebook.com/" class="text-white" target="_blank"><i class="fa fa-fw fa-facebook mx-2 fa-2x"></i></a>
            <a href="https://twitter.com/" class="text-white" target="_blank"><i class="fa fa-fw fa-twitter mx-3 fa-2x"></i></a>
            <a href="https://www.instagram.com/" class="text-white" target="_blank"><i class="fa fa-fw fa-instagram mx-3 fa-2x"></i></a>
          </div>
          <p class="">
            <a href="mailto:ingleanand4@gmail.com" class="text-white"><i class="fa d-inline mr-3 text-secondary fa-envelope-o"></i>itgeca@gmail.com</a>
          </p>
          <p class="">
            <a href="#" class="text-white" target="_blank"><i class="fa d-inline mr-3 fa-map-marker text-secondary"></i>Dept of IT. GECA.</a>
          </p>
        </div>
        <div class="p- col-md-4">
      ...
      <div class="row">
        <div class="col-md-12 mt-1">
          <p class="text-center text-white">© Copyright 2018 &nbsp;Dept. of IT GEC, Aurangabad</p>
        </div>
      </div>
    </div>
  </div>
