     ...
     while($row = mysqli_fetch_array($result))
     {
      $output .= '
        <tr>
            ...
            <td nowrap><button type="submit" class="btn btn-primary ijprbtn-edit" name="ijprbtn-edit" id="' . $row['p_id'] . '"><i class="fa fa-edit"></i></button>
			<button type="submit" class="btn btn-primary ijprbtn-remove" name="ijprbtn-remove" id="' . $row['p_id'] . '"><i class="fa fa-remove"></i></button>
			</td>
