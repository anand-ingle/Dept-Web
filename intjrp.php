     ...
     while($row = mysqli_fetch_array($result))
     {
      $output .= '
        <tr>
            ...
            <td nowrap><button type="submit" class="btn btn-primary btn-edit" id="' . $row['p_id'] . '"><i class="fa fa-edit"></i></button>
			<button type="submit" class="btn btn-primary btn-remove" id="' . $row['p_id'] . '"><i class="fa fa-remove"></i></button>
			</td>
